...
myawesomemenu = {
   ...
   --{ "quit", awesome.quit },
   { "logout", terminal .. " -e xfce4-session-logout"}
}
...
vicious.register(memwidget, vicious.widgets.mem, 
    ...
    text = "<span color='white'>|</span>RAM:"..args[1].."%".."<span color='white'>|</span>"
  	return text
end, 10)
...
--[[vicious.register(cpuwidget, vicious.widgets.cpu,
    ...
    for i=1,#args do
    	...
    	else if args[i] < 10 then
    		args[i] = string.format("  %s", args[i])
    		end
    	end
    -- append to list
...
vicious.register(cpuwidget, vicious.widgets.cpu,
    ...
    i=1
    	...
    	if args[i] > 50 then
    		...
    		args[i] = string.format("0%s", args[i])
    		end
    	end
    -- append to list
	text = args[i]

  return "<span color='white'>|</span>CPU:"..text.."% "
end, 1)

-- Load average
loadaverage = wibox.widget.textbox()
vicious.register(loadaverage, vicious.widgets.uptime, "$4 ")

-- CPU temperature
--tcpu = wibox.widget.textbox()
--vicious.register(tcpu, vicious.widgets.thermal, "$1")

-- Weather forecast
--weather = wibox.widget.textbox()
--vicious.register(weather, vicious.widgets.weather, "UWPP",
--	function (widget, args)
--		return args['city']
--	end)
...
for s = 1, screen.count() do
    ...
    right_layout:add(loadaverage)
    --right_layout:add(tcpu)
...
--awful.util.spawn_with_shell("xrandr --output DFP1 --mode 1920x1080 --rihgt-of LVDS")
